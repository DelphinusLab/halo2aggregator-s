...
impl<C: CurveAffine> Circuit<C::ScalarExt> for AggregatorCircuit<C> {
    ...
    fn synthesize(
        ...
        range_chip.init_table(&mut layouter, &RangeInfo::<C::ScalarExt>::new::<C::Base>())?;

        let mut instance_cells = vec![];
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                instance_cells = self
                    ...
                    .iter()
                    .map(|instance| {
                        cells[instance.cell.region as usize][instance.cell.col][instance.cell.row]
                            .as_ref()
                            .unwrap()
                            .cell()
                            .clone()
